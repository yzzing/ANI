...
if __name__ == '__main__':
    ...
    bucket = 's3://gcu-ml02-010-item'
    s3_model_path = sagemaker.Session().upload_data(local_model_path, bucket)
...
def model_fn(model_dir):
    ...
    sagemaker.s3.S3Downloader.download(s3_uri=model_path, local_path=local_model_path)
